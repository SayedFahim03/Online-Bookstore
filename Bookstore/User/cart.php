	...
	<div class="row">
		...
		<div class="col-sm-8">
			...
			<div class="total">
				...
				<br><br>
				<a href="checkout.php?price=<?php echo $total_price; ?>"><button type="submit" class="btn btn-success float-right"><i class="fa fa-shopping-cart" aria-hidden="true"></i> &nbsp;Checkout</button></a>
			</div>
